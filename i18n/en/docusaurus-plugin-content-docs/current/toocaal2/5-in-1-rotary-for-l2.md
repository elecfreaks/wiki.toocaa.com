...
![](http://wiki-toocaa.oss-cn-hongkong.aliyuncs.com/call.png)_**Note**_**：**_**Pay attention to the direction when installing the stock pulley bracket assembly into the stock column assembly.**_
