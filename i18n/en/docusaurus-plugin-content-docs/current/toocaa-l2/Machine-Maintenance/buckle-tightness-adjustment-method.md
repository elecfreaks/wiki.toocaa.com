 ...
 **step 3** Adjust the tightness of the screw inside the tool carriage.<br/>
 <br/>
 ![](http://wiki-toocaa.oss-cn-hongkong.aliyuncs.com/tips.png)_**TIPS：Clockwise adjustment is for tightening, and counterclockwise adjustment is for loosening. Please adjust according to the actual situation.**_
 <br/>
