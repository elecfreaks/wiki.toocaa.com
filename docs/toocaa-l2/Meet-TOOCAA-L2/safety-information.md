...
![安全须知](http://wiki-toocaa.oss-cn-hongkong.aliyuncs.com/idea.png)请遵循以下操作原则：
...
![激光安全](http://wiki-toocaa.oss-cn-hongkong.aliyuncs.com/idea.png)请遵循以下安全准则：
...
![消防安全](http://wiki-toocaa.oss-cn-hongkong.aliyuncs.com/idea.png)请仔细阅读以下警告和建议：
...
### 4、电气安全信息  
![电气安全](http://wiki-toocaa.oss-cn-hongkong.aliyuncs.com/idea.png)请仔细阅读以下警告和建议：
...
![警示标志](http://wiki-toocaa.oss-cn-hongkong.aliyuncs.com/idea.png)  **提示：您可以右键单击下表中的标签图片进行下载，自行打印后粘贴在激光模块或相关部件上。**
