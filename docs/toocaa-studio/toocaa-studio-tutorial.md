...
#### 状态栏UI示意图
<img src="http://wiki-toocaa.oss-cn-hongkong.aliyuncs.com/TOOCAA%20Studio/%E7%8A%B6%E6%80%81%E6%A0%8F.png" alt="图片描述" width="900" />
...
### 旋转配件工具栏
#### 功能描述
+ **模式选择：** 卡盘旋转模式、球面旋转模式、环形旋转模式、180°可调节翻转模式、滚筒旋转模式
+ **物体直径：** 卡爪选择模式下需输入物体直径
+ **断开链接：** 断开旋转配件模式
