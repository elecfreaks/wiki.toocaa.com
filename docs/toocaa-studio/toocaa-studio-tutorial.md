...
## TOOCAA Studio更新日志
**V1.4.1-2025/02/11**
- **新增** 元素翻转、旋转、排列功能，提升编辑灵活性。  
- **新增** 矩形圆角调整功能，带来更多设计可能。  
- **新增** **TOOCAA Smart Camera** 支持，实现更精准的定位与预览。  
- **新增** **TOOCAA 5-in-1 Rotary for L2** 兼容，拓展多种旋转雕刻模式。  
- **新增** **SVG 导出** 功能，方便跨软件编辑与分享。  
- **新增** **TOOCAA Studio 文件（TCS）导入/导出**，提升项目管理效率。  
- **新增** 元素复制 & 粘贴功能，加速图形编辑流程。  
